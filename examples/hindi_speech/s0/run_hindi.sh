...
checkpoint=
cmvn=true
cmvn_sampling_divisor=1 # 20 means 5% of the training data to estimate cmvn
dir=exp/conformer
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
  ...
  echo "Please prepare wav.scp, text with kaldi format. And place them in data/train and data/dev."
fi
